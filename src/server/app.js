...
export function buildApp({ db, store, validateKey, staticDir = null, logger = false }) {
  ...
  // Aucune route n'écrit vers Linear : les écritures partent du navigateur, avec
  // la clé personnelle de l'utilisateur (src/ui/linearWrites.js). Ce serveur
  // ne lit Linear que pour son cache, et ne persiste que les données locales
  // de planification (réglages, capacités, parts, jours chômés).
