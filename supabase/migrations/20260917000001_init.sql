-- Reprise à l'identique de src/server/db/migrations/001_init.sql (base locale,
-- utilisée par le serveur Fastify de dev) : mêmes tables, pour que
-- supabase/functions/api (qui lit/écrit via src/server/db/repo.js, inchangé)
-- se comporte exactement pareil une fois déployé.
